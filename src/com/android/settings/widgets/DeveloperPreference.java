...
public class DeveloperPreference extends Preference {
    ...
    public DeveloperPreference(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            googleName = typedArray.getString(R.styleable.DeveloperPreference_googleHandle);
    ...
    protected void onBindView(View view) {
        ...
        if (donateLink != null) {
            ...
            final OnPreferenceClickListener openGoogle = new OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {

			if (googleName != null) {

	                    Uri googleURL = Uri.parse("https://plus.google.com/u/0/" + googleName);
            ...
            // changed to clicking the preference to open Google+

            this.setOnPreferenceClickListener(openGoogle);
